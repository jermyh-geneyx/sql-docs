...
The public endpoint always uses the [proxy connection type](connection-types-overview.md#connection-types) regardless of the connection type setting.

## Deploy a SQL managed instance for public endpoint access
...
![Diagram of security configurations for locking down inbound and outbound connectivity.](./media/public-endpoint-overview/managed-instance-vnet.png)
