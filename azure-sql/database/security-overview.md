...
:::image type="content" source="media/security-overview/azure-database-td.jpg" alt-text="Diagram showing SQL Threat Detection monitoring access to the SQL database for a web app from an external attacker and malicious insider.":::
