...
:::image type="content" source="media/xevent-code-ring-buffer/create-event-session-data-storage-ring-buffer.png" alt-text="Screenshot of the New Session SSMS dialog showing the data storage selection page with a ring_buffer target selected." lightbox="media/xevent-code-ring-buffer/create-event-session-data-storage-ring-buffer.png":::
...
- [Extended Events in Azure SQL Database and Azure SQL Managed Instance](xevent-db-diff-from-svr.md)
