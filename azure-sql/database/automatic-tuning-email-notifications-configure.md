...
1. Select the Automation app in the search results.
    ...
    :::image type="content" source="media/automatic-tuning-email-notifications-configure/marketplace-automation.png" alt-text="Screenshot from the Azure portal searching for Automation." lightbox="media/automatic-tuning-email-notifications-configure/marketplace-automation.png":::
...
Select **Save** to save the script. When you are satisfied with the script, and select **Publish** to publish this runbook.
