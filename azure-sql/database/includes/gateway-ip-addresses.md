...
The following table lists the individual Gateway IP addresses and Gateway IP address subnets per region.
...
We strongly encourage customers to move away from relying on **any individual Gateway IP address** (since these addresses will be retired in the future). Instead allow network traffic to reach **both** the individual Gateway IP addresses and Gateway IP address subnets in a region.
