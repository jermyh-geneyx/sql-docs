...
You can use the Azure portal to export a BACPAC of a database in an Azure SQL Database logical server. Exporting a BACPAC of a database from [Azure SQL Managed Instance](../managed-instance/sql-managed-instance-paas-overview.md) using the Azure portal isn't currently supported.
