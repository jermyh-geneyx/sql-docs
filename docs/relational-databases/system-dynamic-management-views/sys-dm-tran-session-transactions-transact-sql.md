...
In Microsoft Fabric, membership in the **Contributor** [workspace role](/fabric/fundamentals/roles-workspaces#-workspace-roles) or more privileged role is needed to query `sys.dm_tran_session_transactions`.
