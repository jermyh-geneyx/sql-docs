...
-   If the next backup is a file backup, use the **Restore Files and Filegroups** task. For more information, see [Restore Files and Filegroups &#40;SQL Server&#41;](../../relational-databases/backup-restore/restore-files-and-filegroups-sql-server.md).  
