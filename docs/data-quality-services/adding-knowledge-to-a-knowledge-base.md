...
-   For a video demonstrating how to perform knowledge discovery, click [here](../sql-server/index.yml).  
...
-   For a video demonstrating how to perform domain management, click [here](../sql-server/index.yml). Note that in this video, you change domain values in the Managing Domain Values page of the Knowledge Discovery wizard. You can also perform these steps in the Domain Values Page of the Domain Management activity.  
