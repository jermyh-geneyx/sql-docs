...
|Windows Management Instrumentation (WMI)|Log files that are generated when interacting with the [Reporting Services WMI provider](../../reporting-services/wmi-provider-library-reference/reporting-services-wmi-provider-library-reference-ssrs.md). |
