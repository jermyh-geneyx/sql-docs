...
| `'DISABLE_OPTIMIZED_HALLOWEEN_PROTECTION'` | Disables optimized Halloween protection. For more information, see [Optimized Halloween protection](../../relational-databases/performance/intelligent-query-processing-details.md#optimized-halloween-protection)<br /><br />**Applies to**: [!INCLUDE [sql-server-2025](../../includes/sssql25-md.md)] |
...
| `'ENABLE_OPTIMIZED_HALLOWEEN_PROTECTION'` | Enables optimized Halloween protection. For more information, see [Optimized Halloween protection](../../relational-databases/performance/intelligent-query-processing-details.md#optimized-halloween-protection).<br /><br />**Applies to**: [!INCLUDE [sql-server-2025](../../includes/sssql25-md.md)] |
