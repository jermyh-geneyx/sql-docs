...
- Bulk import the data by using the [**bcp** utility](../../tools/bcp-utility.md), the .NET [SqlBulkCopy class](/dotnet/api/system.data.sqlclient.sqlbulkcopy), [OPENROWSET (BULK ...)](../../t-sql/functions/openrowset-bulk-transact-sql.md), or the [BULK INSERT](../../t-sql/statements/bulk-insert-transact-sql.md) statement  
