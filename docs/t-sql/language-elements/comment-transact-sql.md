...
|Uncomment the selected text|CTRL+K, CTRL+U|  
 ...
 For more information about keyboard shortcuts, see [SQL Server Management Studio Keyboard Shortcuts](/ssms/sql-server-management-studio-keyboard-shortcuts).  
