...
To complete this exercise, you should have [SQL Server Management Studio (SSMS)](/ssms/sql-server-management-studio-ssms) or another tool that can restore a database backup file and run T-SQL queries.
