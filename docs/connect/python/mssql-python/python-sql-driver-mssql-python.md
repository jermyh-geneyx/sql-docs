...
# Python SQL Driver - mssql-python (preview)
...
> [!TIP]  
> To get help, file an [issue in the mssql-python GitHub repository](https://github.com/microsoft/mssql-python/issues) or visit other Python community resources.
