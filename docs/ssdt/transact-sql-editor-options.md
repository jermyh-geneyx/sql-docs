...
| `SET ARITHABORT` | Terminates a query when an overflow or divide-by-zero error occurs during query execution. For more information, see [SET ARITHABORT](../t-sql/statements/set-arithabort-transact-sql.md). |
...
| **Switch to results tab after the query executes** | Select to automatically set the screen focus to the result set. |
