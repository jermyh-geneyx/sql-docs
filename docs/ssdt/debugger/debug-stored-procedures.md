...
1. In SQL Server Object Explorer, right-click on the same [!INCLUDE [ssDE](../../includes/ssde-md.md)] and select **New Query...**. Ensure you're connected to the same database in which you created the stored procedure.
