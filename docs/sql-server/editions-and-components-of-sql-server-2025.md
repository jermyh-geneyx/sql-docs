...
> [!IMPORTANT]
> The editions and supported features for [!INCLUDE [sssql25-md](../includes/sssql25-md.md)] listed in this article are subject to change until the product is generally available.
