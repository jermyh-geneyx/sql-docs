...
[!INCLUDE [sssql25-md](../includes/sssql25-md.md)] is not supported on Windows Arm64. Only Intel and AMD x86-64 CPUs with [up to 64 cores per NUMA node](compute-capacity-limits-by-edition-of-sql-server.md#numa-64) are currently supported.
...
1. [Repair the SQL Server installation](../database-engine/install-windows/repair-a-failed-sql-server-installation.md) to finalize the upgrade.
