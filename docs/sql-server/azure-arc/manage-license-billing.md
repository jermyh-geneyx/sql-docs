...
- No standalone database outside of an AG except master, msdb, tempdb, and model, irrespective of [database state](../../relational-databases/databases/database-states.md#database-state-definitions).
