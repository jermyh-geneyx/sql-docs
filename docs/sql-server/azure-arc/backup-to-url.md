...
For SQL Server on Azure VMs, review [Backup and restore to URL using managed identities with SQL Server on Azure VMs](/azure/azure-sql/virtual-machines/windows/backup-restore-to-url-using-managed-identities).
...
- [Configure Microsoft Entra authentication for SQL Server](entra-authentication-setup-tutorial.md)
- [Backup and restore to URL using managed identities with SQL Server on Azure VMs](/azure/azure-sql/virtual-machines/windows/backup-restore-to-url-using-managed-identities)
