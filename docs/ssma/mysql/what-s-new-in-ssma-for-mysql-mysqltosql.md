...
The v10.2 release of SSMA for MySQL contains minor performance improvements and bug fixes.
...
- [!INCLUDE [sssql17-md](../../includes/sssql17-md.md)] Preview on Windows and Linux is now a supported target platform for migration. This feature is in technical preview and allows schema and data movement to target SQL Server instances.
