...
This article describes why SQL Server Migration Assistant (SSMA) for Oracle doesn't convert the PL/SQL block when `OUTER JOIN` is used in hierarchical queries.
