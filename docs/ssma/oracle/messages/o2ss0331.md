...
Whenever SSMA encounters a variable for `SYS_REFCURSOR` as a return type of the procedure, and uses the same variable with `FETCH ... INTO` statement, it generates an error message.
...
- [O2SS0330: Unable to convert CLOSE statement (Error)](o2ss0330.md)
