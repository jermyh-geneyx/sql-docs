...
| RHEL 9 | Database Engine | 16.0.4215.2-2 | [Database Engine RPM package](https://packages.microsoft.com/rhel/9/mssql-server-2022/Packages/m/mssql-server-16.0.4215.2-2.x86_64.rpm) |
| RHEL 9 | Extensibility | 16.0.4215.2-2 | [Extensibility RPM package](https://packages.microsoft.com/rhel/9/mssql-server-2022/Packages/m/mssql-server-extensibility-16.0.4215.2-2.x86_64.rpm) |
...
| SLES 15 | Full-Text Search | 16.0.4215.2-2 | [Full-Text Search RPM package](https://packages.microsoft.com/sles/15/mssql-server-2022/Packages/m/mssql-server-fts-16.0.4215.2-2.x86_64.rpm) |
| SLES 15 | High Availability | 16.0.4215.2-2 | [High Availability RPM package](https://packages.microsoft.com/sles/15/mssql-server-2022/Packages/m/mssql-server-ha-16.0.4215.2-2.x86_64.rpm) |
| SLES 15 | PolyBase | 16.0.4215.2-2 | [PolyBase RPM package](https://packages.microsoft.com/sles/15/mssql-server-2022/Packages/m/mssql-server-polybase-16.0.4215.2-2.x86_64.rpm) |
| **Ubuntu** | | | |
| Ubuntu 22.04 | Database Engine | 16.0.4215.2-2 | [Database Engine Debian package](https://packages.microsoft.com/ubuntu/22.04/mssql-server-2022/pool/main/m/mssql-server/mssql-server_16.0.4215.2-2_amd64.deb) |
| Ubuntu 22.04 | Extensibility | 16.0.4215.2-2 | [Extensibility Debian package](https://packages.microsoft.com/ubuntu/22.04/mssql-server-2022/pool/main/m/mssql-server-extensibility/mssql-server-extensibility_16.0.4215.2-2_amd64.deb) |
