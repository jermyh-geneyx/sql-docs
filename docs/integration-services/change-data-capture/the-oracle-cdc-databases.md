...
- [Change Tables (_CT)](#change-tables-_ct)
- [cdc.lsn_time_mapping](#cdclsn_time_mapping)
- [cdc.xdbcdc_config](#cdcxdbcdc_config)
- [cdc.xdbcdc_state](#cdcxdbcdc_state)
- [cdc.xdbcdc_trace](#cdcxdbcdc_trace)
- [cdc.xdbcdc_staged_transactions](#cdcxdbcdc_staged_transactions)
...
|cdc_update_state_interval|10|1|120|False|The size (in Kbytes) of memory chunks allocated for a transaction (a transaction can allocate more than one chunk). See the memory_limit column in [cdc.xdbcdc_config](../../integration-services/change-data-capture/the-oracle-cdc-databases.md#cdcxdbcdc_config) table.|  
