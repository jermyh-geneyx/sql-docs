...
To use .NET API [Microsoft.SqlServer.Dts.Runtime Namespace](/dotnet/api/microsoft.sqlserver.dts.runtime), you need to:

1. Add the following reference for to your cs project:
...
1. Add the following config to your {processname}.exe.config:
   ...
   If you use .NET API [Microsoft.SqlServer.Dts.Runtime Namespace](/dotnet/api/microsoft.sqlserver.dts.runtime), when upgrading to SQL 2025, your projects need to update the references and rebuild for below cases:

1. SSIS Package has **Execute SQL Task**

   Add the following reference of Microsoft.Data.SqlClient to your project and rebuild the project:
